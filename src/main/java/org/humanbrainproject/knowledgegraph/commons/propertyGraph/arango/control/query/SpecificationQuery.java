        ...
        for (SpecField field : fields) {
            if(field.isLeaf()){
                ...
                if(existingCollections!=null && existingCollections.contains(potentialCollection)){
                    ...
                    SpecField idField = new SpecField(JsonLdConsts.ID, null, Collections.singletonList(new SpecTraverse(JsonLdConsts.ID, false)), null, true, false, false, false, null, null);
