...
public class InternalEdge extends Edge {
    ...
    public InternalEdge(String name, Vertex fromVertex, NexusInstanceReference reference, Integer orderNumber,  MainVertex mainVertex) {
        super(name, fromVertex, new ArrayList<>(), orderNumber, mainVertex, ReferenceType.INTERNAL);
