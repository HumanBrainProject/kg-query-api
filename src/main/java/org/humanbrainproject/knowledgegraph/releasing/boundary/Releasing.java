...
public class Releasing {
    ...
    public ReleaseStatusResponse getReleaseStatus(NexusInstanceReference instanceReference, boolean withChildren) {
        return releaseControl.getReleaseStatus(instanceReference, withChildren);
    }

    public Map<String, Object> getReleaseGraph(NexusInstanceReference instanceReference) {
        return releaseControl.getReleaseGraph(instanceReference);
    }
